  ...
  return (loading) ? (
    ...
    <main className="w-full bg-white text-gray-900 font-sans">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-8 mt-8 border-y border-gray-100 py-6">
              <div>
                ...
                <h3 className="font-semibold text-lg sm:text-xl mt-1">
                  {carData?.engine || "N/A"}
                </h3>
              </div>
              ...
              <div>
                ...
                <h3 className="font-semibold text-lg sm:text-xl mt-1">
                  {specs?.transmission || specs?.driveType || "N/A"}
                </h3>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
              ...
              <h3 className="text-xl font-semibold mt-2">
                {specs?.fuelType || carData?.type || "N/A"}
              </h3>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
              ...
              <h3 className="text-xl font-semibold mt-2">
                {specs?.topSpeed ||
                  (carData?.performance && carData?.performance?.topSpeed) ||
                  "N/A"}
              </h3>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-2xl sm:text-3xl font-bold mb-10">Key Features</h2>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {(carData?.features || []).map((feature, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-xl p-5 hover:border-black duration-300"
            >
